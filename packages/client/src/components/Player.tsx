    ...
    async function start() {
      ...
      if (Hls.isSupported()) {
        ...
        const hlsConfig: Partial<import("hls.js").HlsConfig> = {
          ...
          // Generous so the FIRST segment can wait while the server prepares a
          // burned subtitle (fetch/extract) before it produces anything. Steady-
          // state segments arrive fast, so this only affects that initial wait.
          fragLoadingMaxRetryTimeout: 95000,
