...
export function ZoomPanel({ zoom, onChangeZoom, onClose }: {
  ...
  return (
    <div style={styles.panel} role="group" aria-label="Custom Zoom">
      <button className="btn" style={styles.close} onClick={onClose} aria-label="Close custom zoom">✕</button>
      <div style={styles.heading}>Custom Zoom: <span style={styles.value}>{zoom}%</span></div>
      ...
      <input aria-label="Custom Zoom percentage" type="range" min="50" max="200" step="5" value={zoom}
